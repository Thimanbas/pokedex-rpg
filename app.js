...
const pokeImage = document.querySelector('#poke-display');
...
btnsearch.addEventListener('click', () => {
    cardBox.innerHTML = "";
    if (searchtext.value.toLowerCase() == "" ) { //verifica se a area de texto está vazia
        ...
        if (searchtext.value > 898 || searchtext.value < 1) {
            ...
            checkPokemon(searchtext.value.toLowerCase());
            canMove = true;
        }
    }
})
